...
int main (void) {
    ...
    {
    case 'y':
        printf("Great, we knew that we would be able to persuade you to buying our product, it's a very good occassion after all. The last step merely includes you giving us an adress on which we will send you your blind, do you consent on doing that? (Enter y - if yes or n - if not):\n");
        scanf(" %c", &q4);        
        break;
